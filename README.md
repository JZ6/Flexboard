...
> **[v1.4.0-dev.2](https://github.com/JZ6/Flexboard/releases/tag/v1.4.0-dev.2)**&nbsp;&nbsp;•&nbsp;&nbsp;`dev`&nbsp;&nbsp;•&nbsp;&nbsp;9 patches total
<details open>
...
| [Toolbar Hotkeys](#toolbar-hotkeys) | Adds up to twelve customisable hotkey buttons to Gboard's toolbar, each typing text the user sets in Flexboard's settings. |  |
