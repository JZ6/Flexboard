...
> **[v1.4.0-dev.6](https://github.com/JZ6/Flexboard/releases/tag/v1.4.0-dev.6)**&nbsp;&nbsp;•&nbsp;&nbsp;`dev`&nbsp;&nbsp;•&nbsp;&nbsp;10 patches total
<details open>
...
| [Toolbar Hotkeys](#toolbar-hotkeys) | Adds twelve configurable hotkey slots to Gboard's toolbar — each commits a text of your choice on tap. Slots ship as numbered placeholders; clearing a slot's text hides it. Settings edits apply on the next keyboard open. |  |
...
| [Toolbar Slots](#toolbar-slots) | Admit Flexboard's toolbar button ids natively, widening Gboard's own allowed-set array. No other change; reorder and persistence stay stock. |  |
