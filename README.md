...
> **[v2.1.0-dev.0](https://github.com/JZ6/Flexboard/releases/tag/v2.1.0-dev.0)**&nbsp;&nbsp;•&nbsp;&nbsp;`dev`&nbsp;&nbsp;•&nbsp;&nbsp;10 patches total
<details open>
...
| [Vibration slider everywhere](#vibration-slider-everywhere) | Forces Gboard to show its own vibration strength slider on every device, rather than deferring to the system haptic settings page. The slider actually reaches the vibrator instead of being suppressed by a server-side rollout. |  |
