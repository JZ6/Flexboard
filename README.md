...
> **[v1.4.0-dev.7](https://github.com/JZ6/Flexboard/releases/tag/v1.4.0-dev.7)**&nbsp;&nbsp;•&nbsp;&nbsp;`dev`&nbsp;&nbsp;•&nbsp;&nbsp;10 patches total
<details open>
...
| [Toolbar Hotkeys](#toolbar-hotkeys) | Adds twelve configurable hotkey slots to Gboard's toolbar — each commits a text of your choice on tap. A slot appears when its text is set and hides when it's cleared; settings edits apply on the next keyboard open. |  |
